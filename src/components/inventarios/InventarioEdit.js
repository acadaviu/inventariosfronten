...
import { getInventarioPorId, updateInventario } from '../../services/inventarioService';
import Swal from 'sweetalert2';

export const InventarioEdit = () => { 
 ...
 const handleOnSubmit = async (e) => {
    ...
    try {
      ...
      Swal.showLoading();
      const { data } = await updateInventario(inventarioId, inventario);
      Swal.close();
